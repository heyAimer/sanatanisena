...
const HeroSection = () => {
    return (
        <section className="lg:px-16 px-5 flex flex-col sm:flex-row sm:justify-between justify-center items-center sm:justify-items-center sm:h-[665px] sm:py-0 py-6 bg-saffron-gradient">
            <Image
                src="/hanumanji.png"
                alt="hanuman ji"
                width={300}
